...
privileged aspect ProductionTask_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> ProductionTask.fieldNames4OrderClauseFilter = java.util.Arrays.asList("productionTaskConfig", "productionStep", "startDate", "endDate", "taskState", "name", "description");
