...
public class Product extends GpaoBaseEntity {
    ...
    public static TypedQuery<cm.adorsys.gpao.model.Product> findProductsByNameLikeAndWareHouseAndProductSubFamilly(String name, WareHouses wareHouses, ProductSubFamily famille) {
        EntityManager em = Product.entityManager();
