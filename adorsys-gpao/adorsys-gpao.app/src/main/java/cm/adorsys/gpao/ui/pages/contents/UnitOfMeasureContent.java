...
public class UnitOfMeasureContent  extends Composite implements BindableWidgets  {
    ...
    public void onRefreshClick(ClickEvent clickEvent){
    		unitOfMesureController.refreshUdmTable();
    }
    
    @UiHandler("previous")
    public void onPreviousClick(ClickEvent clickEvent){
    ...
    @UiHandler("next")
    public void onNextClick(ClickEvent clickEvent){
	...
	public UnitOfMesureController getUnitOfMesureController() {
		return unitOfMesureController;
	}



	public void setUnitOfMesureController(
			UnitOfMesureController unitOfMesureController) {
		this.unitOfMesureController = unitOfMesureController;
	}
