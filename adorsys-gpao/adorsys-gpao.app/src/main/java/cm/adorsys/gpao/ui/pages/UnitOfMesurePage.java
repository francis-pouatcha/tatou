...
public class UnitOfMesurePage extends Template {
    ...
    @Inject UnitOfMeasureContent  unitOfMeasureContent ;
    @Inject AdministrationSideBar liftmenu ;
    @PostConstruct
	void init(){
		content.add(unitOfMeasureContent);
		sidebar.add(liftmenu);
		mainToolBar.getToolbar().setHTML("<h3><i class='icon-home'></i> Administration/Unites Des Mesures</h3>");
    ...
    public void onPageShown(){
    	unitOfMeasureContent.getUnitOfMesureController().refreshUdmTable();
    }
