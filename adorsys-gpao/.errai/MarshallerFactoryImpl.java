...
@Dependent public class MarshallerFactoryImpl implements MarshallerFactory {
  ...
  private Marshaller<Users> cm_adorsys_gpao_api_model_Users;
  ...
  public MarshallerFactoryImpl() {
    ...
    cm_adorsys_gpao_api_model_Users = new Marshaller<Users>() {
      private Users[] EMPTY_ARRAY = new Users[0];
      public Users[] getEmptyArray() {
        return EMPTY_ARRAY;
      }
      public Class getTypeHandled() {
        return Users.class;
      }
      public Users demarshall(EJValue a0, MarshallingSession a1) {
        try {
          if (a0.isNull()) {
            return null;
          }
          ...
          String objId = obj.get("^ObjectID").isString().stringValue();
          if (a1.hasObject(objId)) {
            return a1.getObject(Users.class, objId);
          }
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: cm.adorsys.gpao.api.model.Users", t);
        }
      }
      public String marshall(Users a0, MarshallingSession a1) {
        if (a0 == null) {
          return "null";
        }
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"cm.adorsys.gpao.api.model.Users\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(640).append("{\"^EncodedType\":\"cm.adorsys.gpao.api.model.Users\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Long.marshall(a0.getId(), a1)).append(",").append("\"version\" : ").append(java_lang_Integer.marshall(a0.getVersion(), a1)).append(",").append("\"userName\" : ").append(java_lang_String.marshall(a0.getUserName(), a1)).append(",").append("\"password\" : ").append(java_lang_String.marshall(a0.getPassword(), a1)).append("}").toString();
      }
    };
    marshallers.put("cm.adorsys.gpao.api.model.Users", cm_adorsys_gpao_api_model_Users);
